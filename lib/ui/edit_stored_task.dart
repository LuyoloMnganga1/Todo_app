...
class _EditTaskState extends State<EditTask> {
  ...
  Widget build(BuildContext context) {
    ...
    _titleController = new TextEditingController(text:  widget.task.title.toString());
    _noteController = new TextEditingController(text:  widget.task.note.toString());
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  _colorPanel(),
                  MyButton(label: "Update Task", onTap: ()=>_validateData()),
                ],
              ),
              SizedBox(height: 25,),
            ],
